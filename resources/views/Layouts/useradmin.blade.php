        ...
        <div class="container">
            <div class="row gy-4">
                ...
                <div class="col-md-4 text-center text-md-start">
                    ...
                    <div class="footer-logos justify-content-center justify-content-md-start">
                ...
                <div class="col-md-4 text-center text-md-start">
                    ...
                    <div class="contact-item d-flex flex-column flex-md-row justify-content-center justify-content-md-start">
                    ...
                    <div class="social-icons justify-content-center justify-content-md-start mt-3">
            ...
            <div class="footer-bottom text-center pt-3 mt-4 border-top border-secondary">
